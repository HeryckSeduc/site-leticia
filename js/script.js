...
const FOTOS = [
    ...
    { src: 'assets/fotos/foto7.webp',  legenda: 'Momentos só nosso...' },
    { src: 'assets/fotos/foto8.webp',  legenda: 'A fantasias mais incriveis da festa!!' },
    ...
    { src: 'assets/fotos/foto11.webp', legenda: 'Você é a minha melhor amiga e amor da minha vida' },
    ...
    { src: 'assets/fotos/foto14.webp', legenda: 'Dia de cosplay, Zoro e Shanks💜' },
...
const MENSAGENS = [
    { tipo: "sep", texto: '04/2023'},
    { tipo: 'delas', texto: 'Vc achou que eu não teria aceitado?',              hora: '21:59' },
    { tipo: 'minha', texto: 'Bom eu não fui totalmente romantico ou coisa parecida e na minha cabeça existia uma chance de vc dizer não kkkkk',               hora: '21:59 ✓✓' },
    { tipo: 'pensamento', texto :'É engraçado pensar como isso começou, era tudo novo para nós dois... mal sabiam eles que iriam ficar 3 anos juntos KKKK'},
    {tipo: 'sep', texto: '04/2024'},
    { tipo: 'minha', texto: '1 ano juntos... e parece que passou voando💜 Obg por tudo, amor. Com vc eu cresci amadureci e aprendi a demonstrar carinho de um jeito que nunca imaginei🩵💜 eu admiro cada detalhe seu tipo seu jeito,sua voz,suas loucuras e até seus gostos duvidosos KKK as vezes só paro e penso: essa é a minha garota como eu tenho tanta sorte?💜 Te amo muito, my Moon🌙💜',                 hora: '00:17 ✓✓' },
    { tipo: 'delas', texto: '1 ano juntos... A gente mudou muito juntos angel.. vc n foi o unico que amaureceu, vc me ensinou que eu n precisava enfrentar tudo sozinha, me fez perceber que eu precisava de alguem especial... alguem que me fizesse sorrir,me sentir segura e amada🩵 E mesmo eu achando que nunca merecia amor...um ruivo apareceu do nada e conquistou completamente meu coração🩵 Eu me orgulho muito de vc, meu garoto. Ainda quero viver tanta coisa ao seu lado... praia, viagens e todos os sonhos que ainda vamos descobrir juntos, como o Rhysand dizia eu esperaria 500 mil anos se soubesse que vc estaria comigo no final🩵💜',  hora: '00:34' },
    { tipo: 'pensamento', texto :'CARA É MUITO TEXTO KKK Aqui a gente tava evoluindo alias a gente conseguiu fazer nosso sonho de viajar juntos e... ver a leticia do passado e vc hj... vc se tornou tão forte hj'},
    {tipo: 'sep', texto: '04/2025'},
    { tipo: 'minha', texto: 'Eu só queria que vc soubesse que eu te amo💜 A gente fez 2 anos juntos e eu amo estar ao se lado🩵💜', hora: '18:23 ✓✓' },
    { tipo: 'delas', texto: 'Eu tbm te amo muito e muito e muito e muito🩵💜🩵💜🩵💜🩵💜 sim e eu nunca imaginei ser tão feliz, eu amo estar com vc e pode ter certeza que sempre vou estar ao seu lado, vc é o sol que me ilumina meu aor🩵💜🩵💜',       hora: '18:40' },
    { tipo: 'pensamento', texto :'OWNT que fofura, como que eu posso voltar no tempo só pra te beijar no passado???'},
    { tipo: 'sep',   texto: 'hoje' },
    { tipo: 'minha', texto: '3 anos juntos!!! cara isso é muito tempo...', hora: 'agora ✓✓' },
];
